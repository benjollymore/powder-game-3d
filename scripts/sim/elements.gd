...
const TABLE := [
	...
	{ "name": "Wall",  "color": Color(0.45, 0.45, 0.48),    "flags": FLAG_IMMOVABLE,               "density": 1000.0, "decay": 0.0,  "decay_to": 0, "spread": 0.0, "smooth": 0.0, "mat": 0, "grain": 0.08, "rough": 0.85 , "category": "common", "tip": "Wall: indestructible, holds everything in." },
	...
	{ "name": "Lava",   "color": Color(1.0, 0.35, 0.05),    "flags": FLAG_LIQUID,                  "density": 150.0,  "decay": 0.0, "decay_to": 0, "spread": 0.25, "emission": 1.0, "air_coupling": 0.02, "foam": 0.0, "opacity": 12.0, "category": "heat", "tip": "Lava: cools into stone, boils water, sets things alight." },
	...
	{ "name": "Gunpowder", "color": Color(0.22, 0.2, 0.18), "flags": FLAG_POWDER | FLAG_FLAMMABLE, "density": 210.0,  "decay": 0.0, "decay_to": 0, "spread": 0.0, "air_coupling": 0.05, "smooth": 1.0, "mat": 1, "grain": 0.5, "rough": 0.95, "category": "powders", "tip": "Gunpowder: a spark runs along the trail, about a cell every two ticks, and sets it all off." },
	...
	{ "name": "Clone",  "color": Color(0.85, 0.75, 0.25),   "flags": FLAG_IMMOVABLE,               "density": 1000.0, "decay": 0.0, "decay_to": 0, "spread": 0.0, "smooth": 0.0, "mat": 7, "grain": 0.05, "rough": 0.6, "category": "special", "tip": "Clone: copies the first solid, powder or liquid that touches it, forever." },
