...
const TABLE := [
	...
	{ "name": "Lava",   "color": Color(1.0, 0.35, 0.05),    "flags": FLAG_LIQUID,                  "density": 150.0,  "decay": 0.0, "decay_to": 0, "spread": 0.25, "emission": 1.8, "air_coupling": 0.02, "foam": 0.0, "category": "heat", "tip": "Lava: cools into stone, boils water, sets things alight." },
	...
	{ "name": "Metal",  "color": Color(0.62, 0.64, 0.68),   "flags": FLAG_IMMOVABLE,               "density": 1000.0, "decay": 0.0, "decay_to": 0, "spread": 0.0, "smooth": 0.0, "mat": 6, "grain": 0.02, "rough": 0.3, "category": "solids", "tip": "Metal: carries heat quickly from one end to the other." },
	# Tranche B (14..20): table-driven behaviour plus bespoke CLONE/VOID rules in sim.glsl.
	{ "name": "Wax",    "color": Color(0.93, 0.88, 0.72),   "flags": FLAG_IMMOVABLE,               "density": 1000.0, "decay": 0.0, "decay_to": 0, "spread": 0.0, "smooth": 0.4, "mat": 6, "grain": 0.03, "rough": 0.55, "category": "solids", "tip": "Wax: soft solid that melts near flame and sets again when cool." },
	{ "name": "Molten wax", "color": Color(0.95, 0.85, 0.55), "flags": FLAG_LIQUID,                "density": 90.0,   "decay": 0.0, "decay_to": 0, "spread": 0.3, "air_coupling": 0.05, "emission": 0.25, "foam": 0.3, "category": "liquids", "tip": "Molten wax: flows slowly and sets back into wax as it cools." },
	...
	{ "name": "Acid",   "color": Color(0.45, 0.95, 0.2),    "flags": FLAG_LIQUID,                  "density": 110.0,  "decay": 0.0, "decay_to": 0, "spread": 0.8, "emission": 0.4, "air_coupling": 0.1, "foam": 0.0, "category": "liquids", "tip": "Acid: eats through sand, wood, plant and more, but never wall." },
